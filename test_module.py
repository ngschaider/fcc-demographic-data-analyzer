...
I EDITED THE TEST MODULE

The signature of assertAlmostEqual is wrong, the msg keyword is supplied as a positional argument and is taken as places argument
